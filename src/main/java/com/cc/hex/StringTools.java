...
//        System.out.println(ArrayUtils.toString(bas));
        String s = "00B71C007B2263223A33332C22706172616D223A7B22616363223A2230227D7D";
        byte[] bytes = string2Byte(s);
        System.out.println(hex2String(bytes, CHARSET_UTF8));
        System.out.println(toHexTable(bytes));
    }
